...
class AuditLog(db.Model):
    ...
    )  # needs to be nullalbe for migration to add this column to the previous table
    ...
    log_creation_timestamp = db.Column(
        db.DateTime(timezone=True), nullable=False, default=datetime.now(timezone.utc)
    )
