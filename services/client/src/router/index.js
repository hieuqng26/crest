  ...
  routes: [
    { path: '/', name: 'home', component: Home, meta: { requiresAuth: true } },
    {
      ...
      children: [
        ...
        // Forecast module
        { path: '/forecast/jobs',    name: 'forecast_jobs', component: () => import('@/views/forecast/ForecastJobs.vue'),   meta: { requiresAuth: true } },
        { path: '/forecast/new',     name: 'forecast_new',  component: () => import('@/views/forecast/ForecastNew.vue'),    meta: { requiresAuth: true } },
        { path: '/forecast/:run_id', name: 'forecast_run',  component: () => import('@/views/forecast/ForecastRunView.vue'), meta: { requiresAuth: true } },
