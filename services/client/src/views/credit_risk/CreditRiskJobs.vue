...
<template>
  <div class="p-5 mx-auto" style="max-width: 1400px">
    ...
    <div class="flex flex-wrap align-items-center gap-3 mb-3">
      ...
      <IconField iconPosition="left" style="width: 22rem" class="ml-auto">
        ...
        <Column header="Progress" style="width: 12rem">
          <template #body="{ data }">
            ...
            <div v-else class="flex align-items-center gap-2">
              ...
              <span class="text-xs font-mono w-3rem text-right text-color-secondary">{{ data.progress ?? 0 }}%</span>
            </div>
          </template>
        </Column>
